...
> 🏆 제1회 KIT 바이브코딩 공모전 · AI활용 차세대 교육 솔루션

---

## ✨ NodeBloom만의 차별점

### 1. AI가 만들고, AI가 검증하고, AI가 수정합니다
스킬트리를 생성한 뒤 가상 학생 100명으로 시뮬레이션하고, 결과를 바탕으로 AI가 자동 개선합니다. 교사의 시행착오를 한 학기에서 5분으로 단축합니다.

### 2. 학생이 포기하기 전에 AI가 먼저 알아챕니다
퀴즈 응답 패턴에서 좌절/자신감을 실시간 감지하고, 학습 이탈 위험을 조기 경보합니다. 혼자 공부하는 시간에도 AI가 지켜봅니다.

### 3. 답을 주지 않는 AI 튜터
소크라틱 방식으로 질문만 던지고, 3번 시도해야 힌트가 열립니다. AI가 학습을 대신하는 것이 아니라 사고력을 키우는 구조입니다.
...
- **팝업 튜토리얼** — 단계별 카드 슬라이드로 기능 안내 (학생/교사/독학러 전용)
...
> _Built with ❤️ for 제1회 KIT 바이브코딩 공모전_
